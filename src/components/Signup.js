  ...
  return (
    <div>
      ...
      <form onSubmit={(e) => e.preventDefault()} className='bg-black rounded-lg absolute p-12 w-full my-16 mx-auto right-0 left-0 text-white'>
        ...
        <p className='text-electric p-2 m-0 '><strong>We are Electric</strong></p>
        ...
        <p className='text-green-800 text-center font-semibold'><strong>Forgot Password?</strong></p>

        <p className='py-4 cursor-pointer text-green-800' onClick={toggleSignInForm}>
          {isSignInForm ? <strong>New to GreendZine? Sign up now</strong> : <strong>Already registered? Sign In Now</strong>}
        </p>
      </form>
    </div>
  );
